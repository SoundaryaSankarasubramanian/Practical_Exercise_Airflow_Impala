...
user_totaltable = BashOperator(task_id='user_totaltable', bash_command=""" impala-shell -q "create table if not exists practical_exercise_1.user_total(time_ran timestamp, total_users bigint, users_added bigint);" """ ,dag=dag)
